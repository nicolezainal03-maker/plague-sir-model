...
df = read.csv('/Users/nicolezainal/Desktop/Roanoke College/Spring 2026/Math 491/Raw Data For 1630-31 Venice, Italy Plague Breakout (St. Eufima Perish) - Raw Data For 1631 Venice Plague.csv')
...
initial_values <- c(
  S = 100000,         # Population of Susepable People in Venice At 1/03/1630
  I = 1,              # Number of People infected on 01/03/1630
  R = 0               # Number of People Who are Recovered/Dead on 01/03/1630
)
